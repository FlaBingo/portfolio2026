...
export const experiences = [
  ...
  },
  {
    ...
    title: "Dr. D.Y. Patil Institute of Engineering, Management and Research, Akurdi.",
    subtitle: "Grade: 8.50 CGPA",
    description:
      "Activities and Societies: TechnoFesta Model Making Competition, Avishkar Hackathon, Kruti No-Code Creation (3rd), SIH Hackathon, Technical Cordinator at MESA.",
    tags: ["Mechanical Engineering", "Communication Skill", "Aptitude", "Python"],
    current: true,
  },
];