...
export const experiences = [
  ...
  },
  {
    ...
    description:
      "Activities and societies: TechnoFesta: Model Competition, Avishkar Hackathon, Kruti: No-Code Creation (3rd), SIH Hackathon, Technical Cordinator at MESA.",
    tags: ["Communication Skill", "Aptitude"],
    current: true,
  },
];