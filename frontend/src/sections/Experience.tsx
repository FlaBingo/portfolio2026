// frontend\src\sections\Experience.tsx
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-muted-foreground animate-fade-in animation-delay-200">
            Tracing the evolution of an interdisciplinary engineer: bridging physical hardware, MERN architecture, and AI-driven logic.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          {/* Need to verify the shadow color */}
          {/* Experience Items */}
          <div className="space-y-12">
            {experiences.map((exp, idx) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-0 md:left-1/2 top-0 w-3 h-3 bg-primary rounded-full -translate-x-1/2 ring-4 ring-background z-10">{exp.current && <span className="absolute inset-0 rounded-full bg-primary animate-ping opacity-75"/>}</div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {exp.tags && exp.tags.map((tag, techIdx) => (
                        <span
                          key={techIdx}
